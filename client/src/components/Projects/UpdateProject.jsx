...
const UpdateProject = ({ isOpen, setIsOpen, id, mutate }) => {
  const task = "";
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-gradient-to-br from-blue-400 to-slate-700 text-white p-6 rounded-lg w-full max-w-lg lg:max-w-2xl shadow-xl cursor-default relative overflow-hidden"
          >
